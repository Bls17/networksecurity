...
dagshub.init(repo_owner="Bls17", repo_name="networksecurity", mlflow=True)

os.environ["MLFLOW_TRACKING_URI"] = "https://dagshub.com/Bls17/networksecurity.mlflow"
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric, best_model_name):
        mlflow.set_registry_uri("https://dagshub.com/Bls17/networksecurity.mlflow")
